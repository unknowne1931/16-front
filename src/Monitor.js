...
const Monitor = () => {
    ...
    useEffect(()=>{
        if(token){
            ...
            fetch(`https://16.171.7.98/upi/module/importing/for/delete/fetch?key=${key}`)
            .then(res => res.json())
            .then(data => setUpi(data))

            fetch(`https://16.171.7.98/user/module/importing/for/delete/fetch?key=${key}`)
            .then(res => res.json())
            .then(data => setUser(data));

            fetch(`https://16.171.7.98/valid/id/leng/data/Length/account/tot?key=${key}`)
            .then(res => res.json())
            .then(data => setLen1(data))

            fetch(`https://16.171.7.98/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module?key=${key}`)
            .then(res => res.json())
            .then(data => setTot(data));

            fetch(`https://16.171.7.98/valid/id/leng/data/Length/child/new?key=${key}`)
            .then(res => res.json())
            .then(data => setLen2(data));

            fetch(`https://16.171.7.98/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module/new/child?key=${key}`)
            .then(res => res.json())
            .then(data => setAlpaid(data));

            fetch(`https://16.171.7.98/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module/new/child/all?key=${key}`)
            .then(res => res.json())
            .then(data => setAllpl(data))

            fetch(`https://16.171.7.98/valid/id/leng/data/Length/child/new/all?key=${key}`)
            .then(res => res.json())
            .then(data => setAlllen4(data));

            fetch(`https://16.171.7.98/valid/id/leng/data/Length/child/new/all/live?key=${key}`)
            .then(res => res.json())
            .then(data => setLive(data));

            const Key1 = "sjhdhg7dshkudfshg"
            fetch(`https://16.171.7.98/q/amount/data/all?key=${Key1}`)
            .then(res => res.json())
    ...
    const Amontpost = (e) =>{
        e.preventDefault();
        axios.post("https://16.171.7.98/amount/data/post",{Amount, code})
        .then(res =>{
                ...
                {email &&
                    <div>
                        ...
                        <div className='roll-01'>
                            {data.map((user,i) =>{
                                const Delt = () =>{
                                    axios.delete(`https://16.171.7.98/delete/data/api/dont/know/ada/up/account/modeis/i/${user._id}?ip=${user.ip}&name=${user.name}&upi=${user.upi}`)
                                    .then(res =>{
                                        if(res.data.Status === "OK"){
                                            window.location.reload();
                                        }else{
                        ...
                        <div className='Monitor-imp-01'>
                            <div className='Monitor-imp-01-div-01'>
                                ...
                                <div className='roll-02'>
                                    ...
                                    {upi.map((user,i) =>{
                                        const Del1 = () =>{
                                            axios.delete(`https://16.171.7.98/delete/data/api/dont/know/ada/upi/${user._id}`)
                                            .then(res =>{
                                                if(res.data.Status === "OK"){
                                                    window.location.reload();
                                                }else{
                            ...
                            <div className='Monitor-imp-01-div-01'>
                                ...
                                {user.map((user,i) =>{
                                    const Del2 = () =>{
                                        axios.delete(`https://16.171.7.98/delete/data/api/dont/know/ada/upi/one/exts/${user._id}`)
                                        .then(res =>{
                                            if(res.data.Status === "OK"){
                                                window.location.reload();
                                            }else{
